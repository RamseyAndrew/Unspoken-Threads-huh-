...
const poem = [
  ...
  "We built this fragile space with glances and maybes, unsaid things blooming in the quiet between breaths. A tender ache, yes... but I'm scared of its echo, scared of 'what if' stealing the color from what's left.",
  ...
  "In the hush where masks slip and truths peek through, I see you seeing me — no more shadows to play. We shouldnt settle for unfinished sentences, and write the next line together, come what may.",
  ...
  "No pressure in these lines, just my truth laid bare, hoping your heart whispers back the same sweet dare. Because this grey? It's beautiful...but I crave the hue, of us, spoken, chosen, finally true. flawed but hoping... ❤️",
   "Na waah gai najua ni 2 am so nimetoa timer ya midnight and hee rhyming is hard but youll get the message. And I love steve Harringtoonnnnn enjoy his greatest banger mwaaah",
   <img src={USImage} alt="US Image" className="poem-image"/>
];
  ...
  return (
    <div className="app">
      {/* <div className="poem-card">
        <img src={USImage} alt="US Image " className="poem-img" />
      </div> */}
      <div className="card">
